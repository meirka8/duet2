...
|---|---|---|---|---|---|
| T-1.1.1 | ~~Install and use TC 11 (under Wine), Double Commander, Krusader, and mc for a full working week each; keep a log of every interaction that felt right or wrong~~ **SKIPPED per deviation note above.** | 3 d | — | A written behavioural log; at least 20 concrete observations that change or confirm a requirement | All |
